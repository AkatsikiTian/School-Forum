  ...
  <div class="me-view-comment-item">
    ...
    <div>
      ...
      <div class="me-view-comment-tools">
        ...
        <a class="me-view-comment-tool" @click="deleteMyComment(comment.id,articleId)" v-if="comment.author.id == this.current_authorid">
...
<script>
  ...
  import {deleteMyCommentById} from "../../api/comment";
  ...
  export default {
    ...
    data() {
      return {
        ...
        current_authorid: this.$store.state.id
      }
    },
    methods: {
      ...
      deleteMyComment(id,articleid){
        let that = this
        deleteMyCommentById(id,articleid).then(data=>{
          console.log(data)
